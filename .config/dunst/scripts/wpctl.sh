...
function send_notification {
    iconSound="/usr/share/icons/Vivid-Glassy-Dark-Icons/status/24@2x/audio-volume-high.svg"
    iconMuted="/usr/share/icons/Vivid-Glassy-Dark-Icons/status/24@3x/audio-volume-muted.svg"
